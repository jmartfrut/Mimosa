...
function Red_Error(x_list)
    ...
    mkpath("data/sims/EM_PB_test_2/Red/Result_withError_POD-DEIM_u_phi_sep_2")
    pvd = paraview_collection("data/sims/EM_PB_test_2/Red/Result_withError_POD-DEIM_u_phi_sep_2" * "/Results", append=false)
    writevtk(model, "data/sims/EM_PB_test_2/Red/Result_withError_POD-DEIM_u_phi_sep_2" * "/DiscreteModel")
    ...
    for i in 1:lastindex(x_list)
        ...
        pvd[Λ_] = createvtk(
            Ω,
            "data/sims/EM_PB_test_2/Red/Result_withError_POD-DEIM_u_phi_sep_2"* "/_Λ_" * Λstring * "_TIME_$Λ_" * ".vtu",
